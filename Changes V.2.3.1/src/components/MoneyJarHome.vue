                ...
                <div class="modal-container">
                  ...
                  <div class="modal-body">
                    <slot name="body">
                      ...
                      <div v-if= "showModal3 = true" @close = "showModal3 = false">
                        <div class="modal-wrapper">
                          <div class="modal-container">
                            <div class="modal-body">
                              <slot name="body">
                        ...
                        <div v-if="users.length">
                          <div v-for="contact in users" class="contact" @click= "addPermissions(currentUser.uid, contact.name, contact.email, contact.id, fullPost.id), showModal3 = false">
                                <h3 @click= "addPermissions(currentUser.uid, contact.name, contact.email, contact.id, fullPost.id), showModal3 = false">{{ contact.name }}</h3>
                                <i><h4 class = "email2" @click= "addPermissions(currentUser.uid, contact.name, contact.email, contact.id, fullPost.id), showModal3 = false">{{ contact.email }}</h4></i>
                                </div>
                                </div>
                              <div v-else>
                  ...
                  <div class="modal-footer">
                    <slot name="footer">
                      <!-- <p>Click contact to add as editor and viewer</p> -->
                      <button @click="showmodal3 = true">Permissions</button>
